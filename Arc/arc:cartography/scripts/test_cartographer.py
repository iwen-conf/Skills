...
def test_cartographer_init_changes_update_and_export(tmp_path: Path) -> None:
    ...
    (project / "src" / "main.js").write_text("export const ok = true;\n", encoding="utf-8")
    (project / "src" / "main.test.js").write_text("test('ok', () => {});\n", encoding="utf-8")
    ...
    assert any(entry["path"] == "src/main.js" for entry in payload["entries"])
