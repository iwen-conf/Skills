...
- Optional dashboard integration: `python3 arc:audit/scripts/integrate_score.py --project-path <project_path> --review-dir <review_dir>`
- Dashboard template reference: `arc:audit/templates/dashboard-template.html`
