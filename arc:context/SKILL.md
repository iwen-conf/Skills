...
- Workspace scaffolding: `python3 arc:context/scripts/scaffold_context_session.py --project-path <project_path> --task-name <task_name> --mode <prime|analyze|snapshot|restore>`
- Upstream adaptation notes: `arc:context/references/context-mode-adaptation.md`
- Data-source playbook: `arc:context/references/data-handling-playbook.md`
