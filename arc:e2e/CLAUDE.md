...
```bash
# 1. 创建测试运行目录
python arc:e2e/scripts/scaffold_run.py --run-dir reports/2026-02-24_10-00-00_test1 --pack e2e
...
# 3. 编译报告
python arc:e2e/scripts/compile_report.py --run-dir reports/2026-02-24_10-00-00_test1

# 4. 校验产物
python arc:e2e/scripts/check_artifacts.py --run-dir reports/2026-02-24_10-00-00_test1 --strict
```
...
pip install -r arc:e2e/requirements.txt
```
