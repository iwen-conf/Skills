...
```bash
# 快速生成失败汇总
python arc:fix/scripts/triage_run.py reports/2026-02-24_10-00-00_test1

# 指定输出路径
python arc:fix/scripts/triage_run.py reports/2026-02-24_10-00-00_test1 --md-out triage-summary.md --json-out triage-summary.json
```
