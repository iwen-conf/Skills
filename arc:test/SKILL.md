...
- Language detection: `python3 arc:test/scripts/detect_lang.py --project-path <path> --json`
- Test scaffolding: `python3 arc:test/scripts/scaffold_tests.py --project-path <path> --target <file_or_dir> --test-types unit,boundary,benchmark,integration [--lang auto] [--output-dir <dir>] [--force] [--dry-run]`
- Test validation: `python3 arc:test/scripts/validate_tests.py --project-path <path> --test-files <file1,file2> [--report-out test-report.md] [--timeout 120]`
