...
```bash
python3 cartography/scripts/cartographer.py init --root . --include "src/**" --exclude "**/node_modules/**"
python3 cartography/scripts/cartographer.py changes --root .
python3 cartography/scripts/cartographer.py update --root .
```
